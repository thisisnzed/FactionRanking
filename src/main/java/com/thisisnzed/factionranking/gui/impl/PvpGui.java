...
public class PvpGui extends Gui {

    private final Ranking ranking;
    private final Settings settings;

    public PvpGui(final Ranking ranking) {
    ...
    public void open(final Player player) {
        final Inventory inventory = Utils.createInventory(54, this.settings.getPvpTitle());
        ...
        inventory.setItem(21, Utils.getFaction(1, sqlHandler, "pvp"));
        inventory.setItem(22, Utils.getFaction(2, sqlHandler, "pvp"));
        inventory.setItem(23, Utils.getFaction(3, sqlHandler, "pvp"));
        inventory.setItem(31, Utils.getBestFactions(sqlHandler, "pvp"));
